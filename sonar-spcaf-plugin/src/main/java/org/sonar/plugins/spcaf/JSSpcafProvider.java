...
public class JSSpcafProvider {

  public static final SpcafConfiguration Spcaf_CONF = new SpcafConfiguration("Spcaf-js", spcafPlugin.REPORT_PATH_KEY);

  private JSSpcafProvider() {
  }
