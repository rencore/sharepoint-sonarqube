...
public class PS1SpcafProvider {

  public static final SpcafConfiguration Spcaf_CONF = new SpcafConfiguration("Spcaf-ps1", spcafPlugin.REPORT_PATH_KEY);

  private PS1SpcafProvider() {
  }
