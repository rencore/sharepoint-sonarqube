...
public class XMLSpcafProvider {

  public static final SpcafConfiguration Spcaf_CONF = new SpcafConfiguration("Spcaf-xml", spcafPlugin.REPORT_PATH_KEY);

  private XMLSpcafProvider() {
  }
