...
public class ASPXSpcafProvider {

  public static final SpcafConfiguration Spcaf_CONF = new SpcafConfiguration("Spcaf-aspx", spcafPlugin.REPORT_PATH_KEY);

  private ASPXSpcafProvider() {
  }
