...
public class CSSSpcafProvider {

  public static final SpcafConfiguration Spcaf_CONF = new SpcafConfiguration("Spcaf-css", spcafPlugin.REPORT_PATH_KEY);

  private CSSSpcafProvider() {
  }
